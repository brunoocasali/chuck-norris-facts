...
module('FactComponent', function(hooks) {
  ...
  test(`renders data's value`, async function(assert) {
    ...
    assert.equal(this.element.querySelector('.qa-fact-value').innerText, 'lorem ipsum');
    assert.equal(this.element.querySelector('.qa-fact-author').innerText, '— Someone about Chuck Norris');
  });
